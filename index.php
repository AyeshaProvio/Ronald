...
<body class=" animsition">
	...
	<!--Main-->
	<main class="vlt-main" id="vlt-main">
		<!--Fullpage Slider-->
		<div class="vlt-fullpage-slider" data-loop-top="" data-loop-bottom="" data-speed="450">
			<!--Home-->
			<!--Section-->
			<div class="vlt-section pp-scrollable hero-section section" data-theme="default" data-anchor="Home">
				<div class="vlt-section__vertical-align">
					<div class="vlt-section__content home-container">
						...
						<div class="container">
							<div class="row">
								<div class="col-lg-5">
									<div class="vlt-gap-160 d-xl-block d-none"></div>
									<!--Animated Block-->
									<div class="vlt-animated-block play-btn" data-animation-name="fadeInUpSm"
										style="animation-delay:0s; animation-duration:700ms;">

									</div>
									<div class="vlt-gap-100 d-xl-block d-none"></div>
									<!--Animated Block-->
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm"
										...
										<h1 class="vlt-large-heading">Ronald<span class="has-accent-color">.</span></h1>
									</div>
			...
			<!--About-->
			<!--Section-->
			<div class="vlt-section pp-scrollable about-section section" data-theme="default" data-anchor="About">
				<div class="vlt-section__vertical-align">
					<div class="vlt-section__content">
						<div class="container">
							<div
								class="row align-items-center justify-content-lg-start justify-content-lg	-center text-lg-start">
								<div class="col-xl-4">
									<!--Animated Block-->
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm"
										style="animation-delay:0s; animation-duration:700ms;">
								...
								<div class="col-xl-8 col-md-8 about-text">
									<!--Animated Block-->
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm"
					...
					<div class="vlt-section__content">
						...
						<div class="container-fluid">
							...
							<div class="vlt-animated-block" data-animation-name="fadeInUpSm"
								...
								<div class="row">
									<div class="col-5 d-inline-block d-sm-none">
										<img src="/assets/img/blog-bg.webp" class="img-fluid w-100" alt="books">
									</div>
									<div class="col-lg-7 ">
										...
										<div class="vlt-animated-block book-des" id="book-des"
										...
										<div class="btns">
											<a target="_blank" href="" class="btn btn-amazon align-items-center">
												<span class="btn-c">Buy on</span>
												<div class="d-flex align-items-center">
													<img src="/assets/img/b&n-logo.webp" class="img-fluid"
											...
											<a class="btn btn-amazon" data-menuanchor="Endorsement"
												onclick="scrollToAnchor('Endorsement')" href="#Endorsement"
												class="text-white">Watch
												Trailer</a>
										</div>
			...
			<!--Testimonials-->
			<!--Section-->
			<div class="vlt-section pp-scrollable test-section section" data-theme="default" data-anchor="Testimonials">
				<div class="vlt-section__vertical-align">
					<div class="vlt-section__content">
						<!--Ken Burn Effect-->
						...
						<div class="container">
							<div class="row align-items-end">
								<div class="col-xl-6">
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm"
										style="animation-delay:0s; animation-duration:700ms;">
										<div class="has-accent-color"><svg xmlns="http://www.w3.org/2000/svg"
												fill="none" viewBox="0 0 75 75" style="height: 75px;">
												<defs />
												<path fill="currentColor"
								...
								<div class="col-xl-4 col-md-6 offset-xl-2">
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm"
										style="animation-delay:.1s; animation-duration:700ms;">
										<!--Content slider-->
										<div class="vlt-content-slider "
											data-navigation-anchor=".vlt-testimonials-anchor" data-effect="" data-gap=""
											data-loop="" data-speed="" data-autoplay="" data-autoplay-speed=""
											data-slides-centered="" data-slide-settings="{}" data-free-mode=""
											data-slider-offset="" data-mousewheel="">
											<div class="swiper-container">
												<div class="swiper-wrapper">
													<div class="swiper-slide">
														<!--Testimonial-->
														<div class="vlt-testimonial">
															<div class="vlt-testimonial__text">
																<p>&quot;Said heaven dry made Them gathering the very
																	second morning us be divide isn't. Saw Seasons
																	winged replenish grass from set can't for he which.
										...
										<!--Slider controls-->
										<div
											class="vlt-slider-controls vlt-slider-controls--style-1 vlt-testimonials-anchor">
											<div class="vlt-swiper-button-prev"><svg xmlns="http://www.w3.org/2000/svg"
													fill="none" viewBox="0 0 24 45">
													<defs />
													<path fill="currentColor" fill-rule="evenodd"
			...
			<!--Blog-->
			<!--Section-->
			<div class="vlt-section pp-scrollable blog-section  section" data-theme="default" data-anchor="Blog">
				<div class="vlt-section__vertical-align">
					<div class="vlt-section__content">
						<div class="container">
							<!--Animated Block-->
							<div class="vlt-animated-block" data-animation-name="fadeInUpSm"
								style="animation-delay:0s; animation-duration:700ms;">
								<h3>Articles and Short Stories</h3>
							</div>
							<div class="vlt-gap-100"></div>
							<div class="row">
								<div class="col-xl-4">
			...
			<!--Contact-->
			<!--Section-->
			<div class="vlt-section pp-scrollable contact-section section" data-theme="default" data-anchor="Contact">
				<div class="vlt-section__vertical-align">
					<div class="vlt-section__content">
						<!--Ken Burn Effect-->
						<div class="vlt-section__ken-burn-background">
							...
							<div class="row align-items-center">
								<div class="col-xl-4">
									...
									<div class="vlt-animated-block" data-animation-name="fadeInUpSm"
										...
										<h3>Contact</h3>
										<div class="vlt-gap-20"></div>
										<p><strong class="text-white">Step Into the Realm</strong> <br>
											Whether you bring a question, a spark of collaboration, or simply a thought
											you’d like to share, I welcome your message. Reader voices shape worlds more
											than you know, and I’m always grateful to hear from those who walk these
											stories with me.
								...
								<div class="col-xl-6 offset-xl-2">
									<div class="vlt-gap-70--lg"></div>
									<!--Animated Block-->
									<div class="vlt-animated-block form-section " data-animation-name="fadeInUpSm"
										style="animation-delay:.1s; animation-duration:700ms;">
										<h4>Cross the threshold—connect with me <span class="has-accent-color">beyond
												the page.</span></h4>
										<div class="vlt-gap-20"></div>
